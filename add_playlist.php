...
if(isset($_POST['submit'])){
   ...
   $add_playlist = $conn->prepare("INSERT INTO `playlist`(id, user_id, title, description, thumb, status) VALUES(?,?,?,?,?,?)");
   $add_playlist->execute([$id, $user_id, $title, $description, $rename, $status]);
